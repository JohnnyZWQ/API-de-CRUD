...
protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
    ...
    // 'filterChain' = continua o fluxo da requisição.
        ...
        // Aplica a autenticação somente no endpoint /jogo/novo
        if (servletPath.equals("/jogo/novo")) {
            ...
            // Para qualquer outro endpoint que não seja /jogo/novo, a requisição passa normalmente
            filterChain.doFilter(request, response);
        }
    }
}
